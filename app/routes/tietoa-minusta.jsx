...
export const meta = () => {
  return [
    { title: "Tietoa minusta - Psykologiaurora.fi" },
    { name: "description", content: "Aurora Huovinen - Psykologi (PsM), Psyykkinen valmentaja. Autan urheilijoita ja liiketoiminnan ammattilaisia kehittämään suorituskykyään." },
  ];
};

export default function TietoaMinusta() {
  return (
